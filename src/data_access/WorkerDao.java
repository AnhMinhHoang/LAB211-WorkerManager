...
public class WorkerDao {
    ...
    public boolean addWorker(List<WorkerData> workers, WorkerData newWorker) {
    ...
    public boolean changeSalary(List<WorkerData> workers, int location, int type) {
        double change = valid.inputDouble("Enter salary");
        WorkerData new_worker = new WorkerData();
    ...
    private void setStatus(List<WorkerData> workers) {
